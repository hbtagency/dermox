  ...
  <div class="service service-small">
    ...
    <?php if ($loop->have_posts()) {?>
      <?php while ( $loop->have_posts() ) : $loop->the_post();?>
        ...
        ?>
        <div class="content-type col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="content-small">
            ...
            <div class="content-service wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="text-small">
                  <div class="number" <?php print($text_numberr_color) ?>><?php print($service_number); ?></div>
                  <div class="title-element" <?php print($text_title_color) ?>><a href="<?php echo esc_url(get_permalink($loop->post->ID)); ?>"><?php the_title(); ?></a></div>
