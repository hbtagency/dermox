        ...
        <div class="gallery-page">
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div class="side-bar-gallery">
              <ul class="sidebar">
                <li class="active"><a href="#"><?php esc_html_e('All Categories','bleute');?></a></li>
                ...
                // now run a query for each gallery family
                foreach( $terms as $term ) {
                 
                    // Define the query
                    $args = array(
                        'post_type' => 'gallery',
                        'gallery_cat' => $term->slug
                    );
                    $query = new WP_Query( $args );
                ?>    
                <li><a href="<?php the_permalink(); ?>"><?php print($term->name); ?></a></li>        
                <?php
          ...
          <div class="gallery-content-right col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <?php
                $terms = get_terms( 'gallery_cat', array(
                    'orderby'    => 'count',
                    'hide_empty' => 0
