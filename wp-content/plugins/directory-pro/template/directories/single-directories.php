...
.cbp-l-event-info {
 ...
 @media only screen and (max-width: 768px) {
  .cbp-l-member-img {
    width: 100%;
    text-align: center; }
    .cbp-l-event-desc{font-size: 16px;}
  .cbp-l-event-info {	  
    width: 100%;
    padding-left: 0; } 
   .cbp-2-project-desc {
...
<div style="max-width: 980px; width: 97%; margin: 40px auto; ">
		...
		<div class="cbp-l-project-subtitle"><?php echo $cat_name;?></div>
	...
	<div class="cbp-l-project-container">
				<div class="cbp-2-project-desc">							
							<div class="cbp-l-project-desc-title"><span style="margin-top:30px"><?php _e('Location Map','ivdirectories'); ?></span> 
			...
			<div class="cbp-l-project-details">
				<div class="cbp-l-project-details-title"><span style="margin-top:30px"><?php _e('Share','ivdirectories'); ?></span>
				</div>			
	...
	<div class="cbp-l-project-container">
				<div class="cbp-2-project-desc">							
						...
						?>				
							...
							?>			
							<div class="cbp-l-project-desc-title"><span><?php _e('Video','ivdirectories'); ?></span> 								
							</div>
							...
							<div class="cbp-l-project-desc-title"><span><?php _e('Event','ivdirectories'); ?></span> 								
								...
								<div class="cbp-l-project-desc-text">
										   ...
										   <div class="cbp-l-inline">
												...
												<div class="cbp-l-inline-right-hd">
													<div class="cbp-l-inline-title"><?php echo get_post_meta($id,'event_title',true); ?></div>													
													<div class="cbp-l-inline-desc">
									...
									<div class="cbp-l-project-desc-text">			
											   ...
											   <div class="cbp-l-inline">
													...
													<div class="cbp-l-inline-right-hd">
														...
														<div class="cbp-l-inline-title"><?php echo get_post_meta($id,'deal_title',true); 
														...
														<div class="cbp-l-inline-desc">											
															...
															<form id="deal_paypa_form" name="deal_paypa_form"  action="https://www.paypal.com/cgi-bin/webscr" onkeypress="return event.keyCode != 13;" method="post">
																...
																<?php
																	...
																	<div class="cbp-l-grid-projects-desc">
																		<input id="deal_client_email" name ="deal_client_email" type="text" placeholder="Enter Email Address"  class="cbp-search-input required">
																	</div>	
