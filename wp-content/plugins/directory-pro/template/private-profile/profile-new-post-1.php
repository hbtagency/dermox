                  ...
                  <div class="portlet-body">
                    <div class="tab-content">
					  ...
					  <?php					
						...
						$sql="SELECT count(*) as total FROM $wpdb->posts WHERE post_type ='directories'  and post_author='".$current_user->ID."' ";									
									...
									<div class=" form-group">
											...
											<div class=" "> 
												<?php
													...
													foreach ( $tags as $tag ) { ?>
														<div class="col-md-4">
														 <label class="form-group"> <input type="checkbox" name="tag_arr[]" id="tag_arr[]" value="<?php echo $tag->name; ?>"> <?php echo $tag->name; ?> </label>  
														</div>
														<?php													
					...
					<div class="panel panel-default">
								...
								<div id="collapseSeven" class="panel-collapse collapse">
								  <div class="panel-body">											
									...
									<div class=" form-group">
										<label for="text" class=" control-label"><?php _e('Title','ivdirectories'); ?></label>
											<input type="text" class="form-control" name="deal-title" id="deal-title" value="" placeholder="<?php _e('Enter Title Here','ivdirectories'); ?>">							
									</div>	
									<?php
									...
									<div class=" form-group">
										<label for="text" class=" control-label"><?php _e('Deals/Coupon Amount '.$currencyCode,'ivdirectories'); ?></label>
											...
											<input type="text" class="form-control" name="deal-amount" id="deal-amount" value="" placeholder="<?php _e('Enter Deals or Coupon Amount on '.$currencyCode.' [ No currency, Only Number]','ivdirectories'); ?>">							
									</div>
									
									<div class=" form-group">
										<label for="text" class=" control-label"><?php _e('Paypal Email Address [Amount will deposit here]','ivdirectories'); ?></label>
											<input type="text" class="form-control" name="deal-paypal" id="deal-paypal" value="" placeholder="<?php _e('Enter Your Paypal Email Address','ivdirectories'); ?>">							
									</div>
